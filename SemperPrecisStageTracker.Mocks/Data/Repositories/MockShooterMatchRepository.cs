...
{
    [Repository]
    public class MockShooterMatchRepository : MockRepositoryBase<ShooterMatch, ISemperPrecisStageTrackerScenario>, IShooterMatchRepository
    {
        public MockShooterMatchRepository(IDataSession dataSession)
