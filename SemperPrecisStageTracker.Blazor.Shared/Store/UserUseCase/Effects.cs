...
public partial class Effects
{
    ...
    {
        return LoadShooterInfo(_userState.Value.User.UserId,dispatcher);
    }

    private async Task DoWork(Contracts.UserContract user, IDispatcher dispatcher)
    {
         if (user == null)
        { 
        ...
        {
            await LoadShooterInfo(user.UserId,dispatcher).ConfigureAwait(false);
        }
    }
