...
{
    [Repository]
    public class ScheduleRepository : EntityFrameworkRepositoryBase<Schedule, SemperPrecisStageTrackerContext>, IScheduleRepository
    {
        public ScheduleRepository(IDataSession dataSession)
            : base(dataSession, c => c.Schedules)
        {
        }
    }
}