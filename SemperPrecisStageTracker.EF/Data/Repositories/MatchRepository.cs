...
{
    [Repository]
    public class MatchRepository : EntityFrameworkRepositoryBase<Match, SemperPrecisStageTrackerContext>, IMatchRepository
    {
        public MatchRepository(IDataSession dataSession)
