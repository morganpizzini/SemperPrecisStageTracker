...
namespace SemperPrecisStageTracker.EF.Migrations
{
    ...
    [Migration("20220712114829_PaymentSpecs")]
    partial class PaymentSpecs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.Match", b =>
                {
                    ...
                    b.Property<bool>("CompetitionReady")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.PaymentType", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(255)
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.Shooter", b =>
                {
                    ...
                    b.Property<string>("RestorePasswordAlias")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.ShooterStageString", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(255)
                    ...
                    b.Property<string>("StageStringId")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.ShooterTeam", b =>
                {
                    ...
                    b.Property<bool>("ShooterApprove")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.StageString", b =>
                {
                    ...
                    b.Property<string>("MuzzleSafePlane")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.TeamPayment", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(255)
            ...
            modelBuilder.Entity("SemperPrecisStageTracker.Models.TeamReminder", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(255)
